...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        builder.Logging
            ...
            {
                consoleBuilder
                    .StripNamespace("BufferingExampleApp1", matchNamespaceExactly: false)
            ...
            // Note, this is a feature of Microsoft.Extensions.Telemetry, not DviZe.Logging.Console.
            .AddGlobalBuffer(LogLevel.Critical);
