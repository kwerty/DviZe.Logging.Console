// Copied from dotnet source.
// https://github.com/dotnet/roslyn/blob/main/src/Compilers/Core/Portable/InternalUtilities/UnicodeCharacterUtilities.cs

using RoslynString = System.String; // Modern .NET doesn't need Roslyn's compat wrapper.
